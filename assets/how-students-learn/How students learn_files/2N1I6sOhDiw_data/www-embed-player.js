...
var pd=!1,qd=new jd;function rd(){for(var a;a=qd.remove();){try{a.f.call(a.scope)}catch(b){gd(b)}ed(ld,a)}pd=!1}
...
function ae(a,b,c,d){if(3==c&&b.onRejected&&!b.h)for(;a&&a.j;a=a.h)a.j=!1;if(b.f)b.f.h=null,fe(b,c,d);else try{b.h?b.g.call(b.context):fe(b,c,d)}catch(e){ge.call(null,e)}ed(Rd,b)}
...
groups:["key"]}]}}];var th=new Set,uh=0,vh=void 0;function wh(a){xh(a,"WARNING")}
...
isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);void 0===vh&&(vh=Math.random()<Te("log_js_error_clusters"));if(!0===vh)a:for(d=u(sh),a=d.next();!a.done;a=d.next())if(a=a.value,a.ma[c.name])for(e=u(a.ma[c.name]),f=e.next();!f.done;f=e.next())if(h=f.value,f=c.message.match(h.regexp)){c.params["error.original"]=f[0];d=h.groups;e={};for(h=0;h<d.length;h++)e[d[h]]=f[h+1],c.params["error."+d[h]]=f[h+1];c.message=a.ta(e);break a}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);if(!(th.has(c.message)||
0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){if(U("kevlar_gel_error_routing")){f=b;d={stackTrace:c.stack};c.fileName&&(d.filename=c.fileName);a=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(d.lineNumber=Number(a[0]),d.columnNumber=Number(a[1])):d.lineNumber=Number(a[0]));a={level:"ERROR_LEVEL_UNKNOWN",message:c.message};"ERROR"===f?a.level="ERROR_LEVEL_ERROR":
"WARNING"===f&&(a.level="ERROR_LEVEL_WARNNING");f={isObfuscated:!0,browserStackInfo:d};d={pageUrl:window.location.href,kvPairs:[]};if(e=c.params)for(h=u(Object.keys(e)),g=h.next();!g.done;g=h.next())g=g.value,d.kvPairs.push({key:"client."+g,value:String(e[g])});rh("clientError",{errorMetadata:d,stackTrace:f,logMessage:a});lg()}a=c.params||{};b={gb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,250),line:c.lineNumber,level:b,"client.name":a.name},D:{url:S("PAGE_NAME",window.location.href),
file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.D){c.stack&&(b.D.stack=c.stack);f=u(Object.keys(a));for(d=f.next();!d.done;d=f.next())d=d.value,b.D["client."+d]=a[d];if(a=S("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(f=u(Object.keys(a)),d=f.next();!d.done;d=f.next())d=d.value,b.D[d]=a[d];a=S("SERVER_NAME",void 0);f=S("SERVER_VERSION",void 0);a&&f&&(b.D["server.name"]=a,b.D["server.version"]=f)}gf(S("ECATCHER_REPORT_HOST","")+"/error_204",b);th.add(c.message);
uh++}}}
...
;var Ah=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};z("yt.msgs_",Ah,void 0);function Bh(a){ye(Ah,arguments)}
...
function Jh(a,b,c){c=void 0===c?null:c;var d=Kh(a),e=document.getElementById(d),f=e&&Eh(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Tf(d,b),b=""+Na(b),Lh[b]=f),g||(e=Mh(a,d,function(){Eh(e,"loaded")||(Ch(e),Wf(d),V(Ta(Xf,d),0))},c)))}
function Mh(a,b,c,d){d=void 0===d?null:d;var e=Hc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Nh(a){a=Kh(a);var b=document.getElementById(a);b&&(Xf(a),b.parentNode.removeChild(b))}
function Oh(a,b){if(a&&b){var c=""+Na(b);(c=Lh[c])&&Vf(c)}}
function Kh(a){var b=document.createElement("a");Xb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+$b(a)}
var Lh={};var Ph=[],Qh=!1;function Rh(){if("1"!=gb(Ae(),"args","privembed")){var a=function(){Qh=!0;"google_ad_status"in window?R("DCLKSTAT",1):R("DCLKSTAT",2)};
Ih("//static.doubleclick.net/instream/ad_status.js",a);Ph.push(Hf(function(){Qh||"google_ad_status"in window||(Oh("//static.doubleclick.net/instream/ad_status.js",a),Qh=!0,R("DCLKSTAT",3))},5E3))}}
function Sh(){return parseInt(S("DCLKSTAT",0),10)}
;function Th(){this.g=!1;this.f=null}
Th.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Ih(b,function(){g.g=!1;window.botguard?Uh(g,c,d,f):(Nh(b),wh(new ph("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Uh(this,c,d,f):wh(Error("Unable to load Botguard from JS")))};
function Uh(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:Ha)}catch(e){wh(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){wh(e)}c&&c(b)}}
Th.prototype.dispose=function(){this.f=null};var Vh=new Th,Wh=!1,Xh=0,Yh="";function Zh(a){U("botguard_periodic_refresh")?Xh=W():U("botguard_always_refresh")&&(Yh=a)}
function $h(a){if(a){if(Vh.g)return!1;if(U("botguard_periodic_refresh"))return 72E5<W()-Xh;if(U("botguard_always_refresh"))return Yh!=a}else return!1;return!Wh}
function ai(){return!!Vh.f}
function bi(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Vh.f?Vh.f.invoke(void 0,void 0,a):null}
;var ci=C().toString();
function di(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=C();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ci)for(a=1,b=0;b<ci.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ci.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var ei=y.ytLoggingDocDocumentNonce_||di();z("ytLoggingDocDocumentNonce_",ei,void 0);var fi=1;function gi(a){this.f=a}
function hi(a){var b={};void 0!==a.f.trackingParams?b.trackingParams=a.f.trackingParams:(b.veType=a.f.veType,void 0!==a.f.veCounter&&(b.veCounter=a.f.veCounter),void 0!==a.f.elementIndex&&(b.elementIndex=a.f.elementIndex));void 0!==a.f.dataElement&&(b.dataElement=hi(a.f.dataElement));void 0!==a.f.youtubeData&&(b.youtubeData=a.f.youtubeData);return b}
gi.prototype.toString=function(){return JSON.stringify(hi(this))};function ii(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function ji(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function ki(a){return S(ji(void 0===a?0:a),void 0)}
z("yt_logging_screen.getRootVeType",ki,void 0);function li(){var a=ki(0),b;a?b=new gi({veType:a,youtubeData:void 0}):b=null;return b}
...
z("yt_logging_screen.getCttAuthInfo",pi,void 0);function qi(a,b,c,d){c=void 0===c?0:c;if(a!==S(ii(c))||b!==S(ji(c)))if(oi(a,d,c),R(ii(c),a),R(ji(c),b),0==c||U("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&ug("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:ei,clientScreenNonce:a},qh)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",qi,void 0);function ri(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=S("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=S("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(K(3,window.location.href));g&&f.push(g);g=J(K(3,d));if(0<=Xa(f,g)||!g&&0==d.lastIndexOf("/",0))if(U("autoescape_tempdata_url")&&(f=document.createElement("a"),Xb(f,d),d=f.href),d){g=d.match(ac);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
b.ved)&&(b=Object.assign({csn:ni()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+$b(d).toString(36),e=e?cc(e):"",zg(b,e,k||5))}else k=b,e="ST-"+$b(d).toString(36),k=k?cc(k):"",zg(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=dc(a,l)+m;a=a instanceof H?a:Ob(a);c.href=Mb(a)}return!0}
;function si(a,b){this.version=a;this.args=b}
;function ti(a,b){this.topic=a;this.f=b}
ti.prototype.toString=function(){return this.topic};var ui=A("ytPubsub2Pubsub2Instance")||new Q;Q.prototype.subscribe=Q.prototype.subscribe;Q.prototype.unsubscribeByKey=Q.prototype.P;Q.prototype.publish=Q.prototype.O;Q.prototype.clear=Q.prototype.clear;z("ytPubsub2Pubsub2Instance",ui,void 0);var vi=A("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",vi,void 0);var wi=A("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",wi,void 0);var xi=A("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",xi,void 0);
...
cb(k.args))}catch(q){throw q.message="yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+q.message,q;}a.call(window,f)}catch(q){T(q)}},xi[b.toString()]?A("yt.scheduler.instance")?Hf(g):V(g,0):g())});
...
v(Fi,si);var Bi=new ti("screen-created",Fi),Gi=[],Hi=0;function Ii(a,b,c){var d=U("use_default_events_client")?void 0:qh;b={csn:a,parentVe:hi(b),childVes:Za(c,function(f){return hi(f)})};
c=u(c);for(var e=c.next();!e.done;e=c.next())e=hi(e.value),(jb(e)||!e.trackingParams&&!e.veType)&&zh(Error("Child VE logged with no data"),"WARNING");c={fa:pi(a),S:a};"UNDEFINED_CSN"==a?Ji("visualElementAttached",b,c):d?ug("visualElementAttached",b,d,c):rh("visualElementAttached",b,c)}
function Ji(a,b,c){Gi.push({payloadName:a,payload:b,options:c});Hi||(Hi=Ci())}
function Di(a){if(Gi){for(var b=u(Gi),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,ug(c.payloadName,c.payload,null,c.options));Gi.length=0}Hi=0}
;function Ki(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Ki.prototype.clone=function(){var a=new Ki,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ja(c)?a[b]=mb(c):a[b]=c}return a};function Li(){M.call(this);this.f=[]}
v(Li,M);Li.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.vb)}M.prototype.o.call(this)};var Mi=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Ni(a){a=a||"";if(window.spf){var b=a.match(Mi);spf.style.load(a,b?b[1]:"",void 0)}else Oi(a)}
function Oi(a){var b=Pi(a),c=document.getElementById(b),d=c&&Eh(c,"loaded");d||c&&!d||(c=Qi(a,b,function(){Eh(c,"loaded")||(Ch(c),Wf(b),V(Ta(Xf,b),0))}))}
...
function Pi(a){var b=Hc(document,"A"),c=new sb(tb,"This URL is never added to the DOM");vb(c);vb(c);Xb(b,new H(Kb,a));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+$b(a)}
;function Ri(a,b,c,d){M.call(this);var e=this;this.m=this.Z=a;this.W=b;this.u=!1;this.api={};this.X=this.G=null;this.H=new Q;Sc(this,Ta(Tc,this.H));this.j={};this.T=this.Y=this.h=this.ea=this.f=null;this.M=!1;this.l=this.C=null;this.aa={};this.Aa=["onReady"];this.da=null;this.oa=NaN;this.U={};this.i=d;Si(this);this.ba("WATCH_LATER_VIDEO_ADDED",this.Ra.bind(this));this.ba("WATCH_LATER_VIDEO_REMOVED",this.Sa.bind(this));this.ba("onAdAnnounce",this.Ca.bind(this));this.Ba=new Li(this);Sc(this,Ta(Tc,this.Ba));
this.V=0;c?this.V=V(function(){e.loadNewVideoConfig(c)},0):d&&(Ti(this),Ui(this))}
v(Ri,M);n=Ri.prototype;n.getId=function(){return this.W};
n.loadNewVideoConfig=function(a){if(!this.g){this.V&&(Xe(this.V),this.V=0);a instanceof Ki||(a=new Ki(a));this.ea=a;this.f=a.clone();Ti(this);this.Y||(this.Y=Vi(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=Vc(Number(a)||a);if(a=this.f.attrs.height)this.m.style.height=Vc(Number(a)||a);Ui(this);this.u&&Wi(this)}};
function Ti(a){var b;a.i?b=a.i.rootElementId:b=a.f.attrs.id;a.h=b||a.h;"video-player"==a.h&&(a.h=a.W,a.f.attrs.id=a.W);a.m.id==a.h&&(a.h+="-player",a.f.attrs.id=a.h)}
...
function Xi(a){var b=!0,c=Yi(a);c&&a.f&&(a=Zi(a),b=Eh(c,"version")===a);return b&&!!A("yt.player.Application.create")}
function Ui(a){if(!a.g&&!a.M){var b=Xi(a);if(b&&"html5"==(Yi(a)?"html5":null))a.T="html5",a.u||$i(a);else if(aj(a),a.T="html5",b&&a.l)a.Z.appendChild(a.l),$i(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.C=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==Je(d||"").player_bootstrap_method?A("yt.player.Application.createAlternate")||A("yt.player.Application.create"):A("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.Z,e,a.i);$i(a)};
a.M=!0;b?a.C():(Ih(Zi(a),a.C),(b=a.i?a.i.cssUrl:a.f.assets.css)&&Ni(b),bj(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Yi(a){var b=Dc(a.h);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.h));return b}
function $i(a){if(!a.g){var b=Yi(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||cj(a)):a.oa=V(function(){$i(a)},50)}}
function cj(a){Si(a);a.u=!0;var b=Yi(a);b.addEventListener&&(a.G=dj(a,b,"addEventListener"));b.removeEventListener&&(a.X=dj(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=dj(a,b,e))}for(var f in a.j)a.G(f,a.j[f]);Wi(a);a.Y&&a.Y(a.api);a.H.O("onReady",a.api)}
function dj(a,b,c){var d=b[c];return function(){try{return a.da=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.da=e,Ie(e))}}}
function Si(a){a.u=!1;if(a.X)for(var b in a.j)a.X(b,a.j[b]);for(var c in a.U)Xe(parseInt(c,10));a.U={};a.G=null;a.X=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.ba.bind(a);a.api.removeEventListener=a.Wa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Ha.bind(a);a.api.getPlayerType=a.Ia.bind(a);a.api.getCurrentVideoConfig=a.Ga.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Qa.bind(a)}
n.Qa=function(){return this.u};
n.ba=function(a,b){var c=this,d=Vi(this,b);if(d){if(!(0<=Xa(this.Aa,a)||this.j[a])){var e=ej(this,a);this.G&&this.G(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&V(function(){d(c.api)},0)}};
n.Wa=function(a,b){if(!this.g){var c=Vi(this,b);c&&he(this.H,a,c)}};
function Vi(a,b){var c=b;if("string"==typeof b){if(a.aa[b])return a.aa[b];c=function(){var d=A(b);d&&d.apply(y,arguments)};
a.aa[b]=c}return c?c:null}
function ej(a,b){var c="ytPlayer"+b+a.W;a.j[b]=c;y[c]=function(d){var e=V(function(){if(!a.g){a.H.O(b,d);var f=a.U,g=String(e);g in f&&delete f[g]}},0);
kb(a.U,String(e))};
return c}
...
n.Ia=function(){return this.T||(Yi(this)?"html5":null)};
n.Ha=function(){return this.da};
function aj(a){a.cancel();Si(a);a.T=null;a.f&&(a.f.loaded=!1);var b=Yi(a);b&&(Xi(a)||!bj(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.Z;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.C){var a=Zi(this);Oh(a,this.C)}Xe(this.oa);this.M=!1};
n.o=function(){aj(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){T(b)}this.aa=null;for(var a in this.j)y[this.j[a]]=null;this.ea=this.f=this.api=null;delete this.Z;delete this.m;M.prototype.o.call(this)};
...
;function mj(a){a=void 0===a?!1:a;M.call(this);this.f=new Q(a);Sc(this,Ta(Tc,this.f))}
...
v(nj,mj);function oj(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Id(a),d.i))}}
nj.prototype.o=function(){this.i=this.h=null;mj.prototype.o.call(this)};function pj(a){M.call(this);this.f=a;this.f.subscribe("command",this.ya,this);this.h={};this.j=!1}
...
n.o=function(){var a=this.f;a.g||he(a.f,"command",this.ya,this);this.f=null;for(var b in this.h)qj(this,b);M.prototype.o.call(this)};function tj(a,b){pj.call(this,b);this.i=a;this.start()}
...
v(uj,M);uj.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Ie(e)}}};
uj.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function vj(){var a=this.g=new uj(!!S("WIDGET_ID_ENFORCE")),b=B(this.Va,this);a.j=b;a.l=null;this.g.channel="widget";if(a=S("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=vj.prototype;n.Va=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,wj(this,a)),this.j[a]=!0)):this.ua(a,b,c)};
n.ua=function(){};
function wj(a,b){return B(function(c){this.sendMessage(b,c)},a)}
...
n.cb=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());xj(this,a)};
n.fb=function(){var a={sphericalProperties:this.f.getSphericalProperties()};xj(this,a)};
n.dispose=function(){vj.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function zj(a,b,c){M.call(this);this.f=a;this.i=c;this.j=Af(window,"message",B(this.l,this));this.h=new nj(this,a,b);Sc(this,Ta(Tc,this.h))}
...
zj.prototype.o=function(){Bf(this.j);this.f=null;M.prototype.o.call(this)};function Aj(){var a=mb(Bj),b;return Xd(new P(function(c,d){a.onSuccess=function(e){We(e)?c(e):d(new Cj("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Cj("Unknown request error","net.unknown",e))};
a.R=function(e){d(new Cj("Request timed out","net.timeout",e))};
...
Dj.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Od(a)?a:Ej(a)):2===this.g&&b?(a=b.call(c,this.f),Od(a)?a:Fj(a)):this};
...
;function Gj(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Hj;this.isTimeout=a instanceof Cj&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Yd}
v(Gj,F);Gj.prototype.name="BiscottiError";function Hj(){F.call(this,"Biscotti ID is missing from server")}
v(Hj,F);Hj.prototype.name="BiscottiMissingError";var Bj={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ij=null;function De(){if("1"===gb(Ae(),"args","privembed"))return Vd(Error("Biscotti ID is not available in private embed mode"));Ij||(Ij=Xd(Aj().then(Jj),function(a){return Kj(2,a)}));
return Ij}
function Jj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Hj;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Hj;a=a.id;Ee(a);Ij=Ej(a);Lj(18E5,2);return a}
function Kj(a,b){var c=new Gj(b);Ee("");Ij=Fj(c);0<a&&Lj(12E4,a-1);throw c;}
function Lj(a,b){V(function(){Xd(Aj().then(Jj,function(c){return Kj(b,c)}),Ha)},a)}
function Mj(){try{var a=A("yt.ads.biscotti.getId_");return a?a():De()}catch(b){return Vd(b)}}
;function Nj(a){if("1"!==gb(Ae(),"args","privembed")){a&&Ce();try{Mj().then(function(){},function(){}),V(Nj,18E5)}catch(b){T(b)}}}
;var Y=A("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function Oj(){this.f=S("ALT_PREF_COOKIE_NAME","PREF");var a=zc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
...
Ia(Oj);function Sj(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Tj(a)||c.some(function(e){return!Tj(e)}))throw Error("Only objects may be merged.");
...
var dk=bk.performance||bk.mozPerformance||bk.msPerformance||bk.webkitPerformance||new ck;var ek=!1;B(dk.clearResourceTimings||dk.webkitClearResourceTimings||dk.mozClearResourceTimings||dk.msClearResourceTimings||dk.oClearResourceTimings||Ha,dk);function fk(a){var b=gk(a);if(b.aft)return b.aft;a=S((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function hk(a){var b;(b=A("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ua("ytcsi."+(a||"")+"data_",b));return b}
function ik(a){a=hk(a);a.info||(a.info={});return a.info}
function gk(a){a=hk(a);a.tick||(a.tick={});return a.tick}
function jk(a){var b=hk(a).nonce;b||(b=di(),hk(a).nonce=b);return b}
...
ok.prototype.tick=function(a,b,c){qk(this,"tick_"+a+"_"+b)||rh("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
ok.prototype.info=function(a,b){var c=Object.keys(a).join("");qk(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,rh("latencyActionInfo",c))};
ok.prototype.span=function(a,b){var c=Object.keys(a).join("");qk(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,rh("latencyActionSpan",a))};
function qk(a,b){nk[b]=nk[b]||{count:0};var c=nk[b];c.count++;c.time=W();a.f||(a.f=Ff(function(){var d=W(),e;for(e in nk)nk[e]&&6E4<d-nk[e].time&&delete nk[e];a&&(a.f=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new ph("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||wh(c)),!0):!1}
...
;function yk(a,b,c){if(null!==b)if(ik(c)[a]=b,wk(c)){var d=b;b=xk(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in rk){b=rk[a];0<=Xa(sk,b)&&(d=!!d);a in uk&&"string"===typeof d&&(d=uk[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Sj({},e)}else 0<=Xa(vk,a)||wh(new ph("Unknown label logged with GEL CSI",
...
e.join(",");b=!!c.ap;U("debug_csi_data")&&(c=A("yt.timing.csiData"),c||(c=[],Ua("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var t in f)f.hasOwnProperty(t)&&(c+="&"+t+"="+f[t]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var p=void 0===p?"":p;sf(f,p)||pf(f,void 0,void 0,void 0,p)}else pf(f);z("yt.timing."+(a||"")+"pingSent_",!0,void 0);yi(ak,new Yj(m.aft+(Number(g)||0),a))}}
if(U("overwrite_polyfill_on_logging_lib_loaded")){var Ck=window;Ck.ytcsi&&(Ck.ytcsi.info=yk,Ck.ytcsi.tick=zk)};var Dk=null,Ek=null,Fk=null,Gk={};function Hk(a){var b=a.id;a=a.ve_type;var c=fi++;a=new gi({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Gk[b]=a;b=ni();c=li();b&&c&&Ii(b,c,[a])}
function Ik(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(qi(b,a),a=li()))for(var c in Gk){var d=Gk[c];d&&Ii(b,a,[d])}}
function Jk(a){Gk[a.id]=new gi({trackingParams:a.tracking_params})}
function Kk(a){var b=ni(),c=Gk[a.id];if(b&&c){a=U("use_default_events_client")?void 0:qh;c={csn:b,ve:hi(c),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var d={fa:pi(b),S:b};"UNDEFINED_CSN"==b?Ji("visualElementGestured",c,d):a?ug("visualElementGestured",c,a,d):rh("visualElementGestured",c,d)}}
function Lk(a){a=a.ids;var b=ni();if(b)for(var c=0;c<a.length;c++){var d=Gk[a[c]];if(d){var e=b,f=U("use_default_events_client")?void 0:qh;d={csn:e,ve:hi(d),eventType:1};var g={fa:pi(e),S:e};"UNDEFINED_CSN"==e?Ji("visualElementShown",d,g):f?ug("visualElementShown",d,f,g):rh("visualElementShown",d,g)}}}
...
z("writeEmbed",function(){var a=S("PLAYER_CONFIG",void 0);Nj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=S("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);S("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?Dc(b):b;var e=gj+"_"+Na(b),f=fj[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new Ri(b,e,a,void 0),fj[e]=f,Wf("player-added",f.api),Sc(f,Ta(hj,f)));a=f.api;Dk=a;a.addEventListener("onScreenChanged",Ik);a.addEventListener("onLogClientVeCreated",Hk);a.addEventListener("onLogServerVeCreated",Jk);a.addEventListener("onLogVeClicked",Kk);a.addEventListener("onLogVesShown",Lk);d=S("POST_MESSAGE_ID","player");S("ENABLE_JS_API")?Fk=new yj(a):S("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(Ek=new zj(window.parent,d,c),Fk=new tj(a,Ek.h));
c=S("BG_P",void 0);$h(c)&&(S("BG_I")||S("BG_IU"))&&(Wh=!0,Vh.initialize(S("BG_I",null),S("BG_IU",null),c,Zh,void 0,!!S("BG_CE",!1)));Rh()},void 0);
z("yt.www.watch.ads.restrictioncookie.spr",function(a){pf(a+"mac_204?action_fcts=1");return!0},void 0);
var Mk=He(function(){zk("ol");var a=Oj.getInstance(),b=!!((Rj("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&xd(document.body,"exp-invert-logo"))if(c&&!xd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!xd(d,"inverted-hdpi")){var e=vd(d);wd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&xd(document.body,"inverted-hdpi")&&yd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Rj(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),Nk=He(function(){var a=Dk;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();S("PL_ATT")&&Vh.dispose();a=0;for(var b=Ph.length;a<b;a++)Jf(Ph[a]);Ph.length=0;Nh("//static.doubleclick.net/instream/ad_status.js");Qh=!1;R("DCLKSTAT",0);Uc(Fk,Ek);if(a=Dk)a.removeEventListener("onScreenChanged",Ik),a.removeEventListener("onLogClientVeCreated",Hk),a.removeEventListener("onLogServerVeCreated",Jk),a.removeEventListener("onLogVeClicked",Kk),a.removeEventListener("onLogVesShown",Lk),a.destroy();Gk={}});
window.addEventListener?(window.addEventListener("load",Mk),window.addEventListener("unload",Nk)):window.attachEvent&&(window.attachEvent("onload",Mk),window.attachEvent("onunload",Nk));Ua("yt.abuse.player.botguardInitialized",A("yt.abuse.player.botguardInitialized")||ai);Ua("yt.abuse.player.invokeBotguard",A("yt.abuse.player.invokeBotguard")||bi);Ua("yt.abuse.dclkstatus.checkDclkStatus",A("yt.abuse.dclkstatus.checkDclkStatus")||Sh);
Ua("yt.player.exports.navigate",A("yt.player.exports.navigate")||ri);Ua("yt.util.activity.init",A("yt.util.activity.init")||Lf);Ua("yt.util.activity.getTimeSinceActive",A("yt.util.activity.getTimeSinceActive")||Of);Ua("yt.util.activity.setTimestamp",A("yt.util.activity.setTimestamp")||Mf);}).call(this);
